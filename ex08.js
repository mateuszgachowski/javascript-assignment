...
console.log.  i.e. Implement a logging function that prepends a namespace
string to its output.
...
Function.prototype.apply allows us to execute a function, supply a new
'value for this' (we can ignore in this case), and then an array of arguments
